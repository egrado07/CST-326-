   ...
   private void Start()
{
    ...
    // Debugging: Check if UI elements are assigned
    if (scoreText == null || coinsText == null || timerText == null)
    {
        Debug.LogError("GameManager: UI Text elements are NOT assigned in the Inspector!");
   ...
   private void UpdateTimer()
{
    ...
    if (levelTime <= 0)
    {
        Debug.Log("Player failed to complete the level in time!");
